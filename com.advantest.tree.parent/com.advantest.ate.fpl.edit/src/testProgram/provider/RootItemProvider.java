...
/**
 * This is the item provider adapter for a {@link testProgram.Root} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RootItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TestProgramPackage.Literals.ROOT__PROGRAMS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Root.class)) {
			case TestProgramPackage.ROOT__PROGRAMS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TestProgramPackage.Literals.ROOT__PROGRAMS,
				 TestProgramFactory.eINSTANCE.createTestProgram()));
	}
