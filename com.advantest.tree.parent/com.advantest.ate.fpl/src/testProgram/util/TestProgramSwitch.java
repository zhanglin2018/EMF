 ...
 * @generated
 */
public class TestProgramSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TestProgramPackage.SUITE: {
				Suite suite = (Suite)theEObject;
				T result = caseSuite(suite);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestProgramPackage.TEST_SUITE: {
				TestSuite testSuite = (TestSuite)theEObject;
				T result = caseTestSuite(testSuite);
				if (result == null) result = caseSuite(testSuite);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestProgramPackage.TEST_FLOW: {
				TestFlow testFlow = (TestFlow)theEObject;
				T result = caseTestFlow(testFlow);
				if (result == null) result = caseSuite(testFlow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestProgramPackage.TEST_PROGRAM: {
				TestProgram testProgram = (TestProgram)theEObject;
				T result = caseTestProgram(testProgram);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestProgramPackage.ROOT: {
	 ...
	 * @generated
	 */
	public T caseTestFlow(TestFlow object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Test Program</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Test Program</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTestProgram(TestProgram object) {
		return null;
	}
