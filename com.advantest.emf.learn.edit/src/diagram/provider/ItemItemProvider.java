...
/**
 * This is the item provider adapter for a {@link diagram.Item} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addQuatityPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DiagramPackage.Literals.ITEM__PRODUCT_NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Quatity feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addQuatityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Item_quatity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Item_quatity_feature", "_UI_Item_type"),
				 DiagramPackage.Literals.ITEM__QUATITY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DiagramPackage.Literals.ITEM__PRICE,
				 true,
				 false,
				 false,
