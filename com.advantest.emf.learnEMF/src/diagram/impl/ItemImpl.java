 ...
 *   <li>{@link diagram.impl.ItemImpl#getQuantity <em>Quantity</em>}</li>
...
public class ItemImpl extends MinimalEObjectImpl.Container implements Item {
	...
	public void setQuantity(int newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.ITEM__QUANTITY, oldQuantity, quantity));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DiagramPackage.ITEM__QUANTITY:
				return getQuantity();
